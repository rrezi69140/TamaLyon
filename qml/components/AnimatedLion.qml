...
Item {
    ...
    property string getCurrentImageSource: {
        ...
        if (isEating) {
            imageSource = "qrc:/images/lion_mange_0" + (currentFrame + 1) + ".png"
            console.log("[AnimatedLion] 🍽️ Mode manger - Frame:", currentFrame + 1, "Image:", imageSource)
            return imageSource
        }
        
        if (!lionRef) {
            imageSource = "qrc:/images/lion_normal.png"
        ...
        if (lionRef.estMort) {
            imageSource = "qrc:/images/lion_mort.png"
