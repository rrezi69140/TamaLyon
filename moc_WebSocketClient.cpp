...
void WebSocketClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->stateReceived((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (WebSocketClient::*)(const QJsonObject & )>(_a, &WebSocketClient::stateReceived, 0))
            return;
    }
}
...
// SIGNAL 0
void WebSocketClient::stateReceived(const QJsonObject & _t1)
{
